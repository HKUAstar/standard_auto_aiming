...
MAX_NUM=120 #the max_number of img used in detecting spin
...
class AutoAiming:
    ...
    def callback(self, img):
        ...
        self.target_num.append (len (res))
        if len (self.target_num>MAX_NUM):
            self.target_num.pop(0)
        
        if detect_spin (self, self.target_num)==True:
            ros.loginfo("Spinning!!!!!!")
        else:
            ros.loginfo("No")
