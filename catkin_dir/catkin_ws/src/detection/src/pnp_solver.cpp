...
{
    // Unit: m
    constexpr double small_half_x = SMALL_ARMOR_HEIGHT / 2.0 / 1000.0;
    constexpr double small_half_y = SMALL_ARMOR_WIDTH / 2.0 / 1000.0;
    constexpr double large_half_x = LARGE_ARMOR_HEIGHT / 2.0 / 1000.0;
    constexpr double large_half_y = LARGE_ARMOR_WIDTH / 2.0 / 1000.0;

    // Start from left top in counterclockwise order
